<script>
	...
	'1312','1311', 'C3','1135','1133','1131','1136','1134','1132','1130','1127','1125','1123','1121'
	];
	var yRooms = ['Attendance Office','1520','1521','1522','ARD','H16', '1510','1512','1513','1514','1515','1118','1117',
	'1116','1115','1111','1107','1103','1101','1102','1106'
	];
	var the1315 = ['Attendance Office', 'H1', 'C1', 'H2','1327','1326','1325','1324','H3', '1323', '1322','1320', 'H4', 'C2','C6','H9','1520','1521','H10','1522','ARD',
			...
			'H12','1513','1515','1514','C7','H13','C8'];
	
	var locations1315 = [[80, -109.160156],
		[80, -98.5],
		[78.5, -98.5],
		[78.5, -82.8],
		[79.15, -93.515625],
	...
	var keys = the1315.concat(the11s);
	var values = locations1315.concat(locations11);
